...
我們將會根據漏洞的嚴重程度、提交的完善程度，以及我們可用的預算，自主決定獎金的級別。若提供獎金，將僅以美元支付。

本獎金標準自 2026.05.19 起生效，不溯及既往。
...
重要的安全漏洞允許攻擊者讀取或者更改未經許可的敏感數據。重要安全漏洞一般而言比關鍵安全漏洞波及範圍更小，但是仍然可以給攻擊者打開大量未經許可的權限。例如：
...
我們保留對漏洞提交的價值和有效性的最終決定權。本項目在未來可能會變更和取消；包含自 2026.05.19 起生效的獎金標準在內，任何變更均不溯及既往。感謝你和我們一起讓 Matters 更加安全！
