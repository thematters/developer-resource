;(function (i) {
  'function' === typeof define && define.amd
    ...
    ? (module.exports = function (g, l, r, s) {
        g || (g = window)
  ...
  function z(a, c) {
    t === o &&
      (t =
        -1 ===
        x
          .serializeToString(i.parseXML(A['xl/worksheets/sheet1.xml']))
          .indexOf('xmlns:r'))
      ...
      if (i.isPlainObject(b)) {
        ...
        if (t) {
          ...
          for (h = e.attributes.length - 1; 0 <= h; h--) {
            ...
            var m = e.attributes[h].nodeValue
            ;-1 !== f.indexOf(':') &&
              (u.push({ name: f, value: m }), e.removeAttribute(f))
          }
          h = 0
          for (f = u.length; h < f; h++)
            (m = b.createAttribute(
              u[h].name.replace(':', '_dt_b_namespace_token_')
            )),
              (m.value = u[h].value),
              e.setAttributeNode(m)
        }
  ...
  if (
    ...
    var v = j.document.createElementNS('http://www.w3.org/1999/xhtml', 'a'),
      ...
      C = function (a) {
        setTimeout(function () {
          'string' === typeof a
            ? (j.URL || j.webkitURL || j).revokeObjectURL(a)
            : a.remove()
        }, 4e4)
      },
      D = function (a) {
      ...
      E = function (a, c, d) {
        ...
        b.readyState = b.INIT
        if (J)
          (e = (j.URL || j.webkitURL || j).createObjectURL(a)),
            setTimeout(function () {
              v.href = e
              v.download = c
          ...
          f.onloadend = function () {
            var a = B
              ? f.result
              : f.result.replace(/^data:[^;]*;/, 'data:attachment/file;')
          ...
          e || (e = (j.URL || j.webkitURL || j).createObjectURL(a)),
            d
              ? (j.location.href = e)
              : j.open(e, '_blank') || (j.location.href = e),
            (b.readyState = b.DONE),
            h(),
            C(e)
      },
    ...
    F = function (a, c) {
      for (
        var d = c.newline
          ...
          h = c.fieldSeparator,
          f = RegExp(e, 'g'),
          i = c.escapeChar !== o ? c.escapeChar : '\\',
          m = function (a) {
            for (var b = '', c = 0, d = a.length; c < d; c++)
              0 < c && (b += h),
                (b += e ? e + ('' + a[c]).replace(f, i + e) + e : a[c])
            return b
          },
          j = c.header ? m(b.header) + d : '',
          g = c.footer && b.footer ? d + m(b.footer) : '',
          l = [],
          y = 0,
          O = b.body.length;
        y < O;
  ...
  n.ext.buttons.csvHtml5 = {
    ...
    action: function (a, c, d, b) {
      ...
      !1 !== c
        ? (c || (c = l.characterSet || l.charset), c && (c = ';charset=' + c))
        : (c = '')
      b.bom && (a = '﻿' + a)
  ...
  n.ext.buttons.excelHtml5 = {
    ...
    action: function (a, c, d, b) {
      ...
      var e = this,
        ...
        d = function (a) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            for (var d = b, e = ''; 0 <= d; )
              (e = String.fromCharCode((d % 26) + 65) + e),
                (d = Math.floor(d / 26) - 1)
            var d = e + '' + m,
              g = null
            if (!(null === a[b] || a[b] === o || '' === a[b])) {
              ...
              for (var k = 0, n = H.length; k < n; k++)
                if (
                  ((e = H[k]),
                  a[b].match && !a[b].match(/^0\d+/) && a[b].match(e.match))
                ) {
                  g = a[b].replace(/[^\d\.\-]/g, '')
                  e.fmt && (g = e.fmt(g))
                  g = p(f, 'c', {
                    attr: { r: d, s: e.style },
                    children: [p(f, 'v', { text: g })],
                  })
                  break
                }
              g ||
      ...
      b.footer &&
        c.footer &&
        (d(c.footer, h), i('row:last c', f).attr('s', '2'))
      d = p(f, 'cols')
      i('worksheet', f).prepend(d)
      k = 0
      for (n = c.header.length; k < n; k++)
        d.appendChild(
          p(f, 'col', {
            attr: { min: k + 1, max: k + 1, width: I(c, k), customWidth: 1 },
          })
        )
  ...
  n.ext.buttons.pdfHtml5 = {
    ...
    action: function (a, c, d, b) {
      ...
      for (var f = 0, j = a.body.length; f < j; f++)
        h.push(
