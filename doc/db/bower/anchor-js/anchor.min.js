  ...
  function A(A) {
    ...
    ;(this.options = A || {}),
      ...
      (this.add = function (A) {
        ...
        if (
          (e(this.options),
          'touch' === (g = this.options.visible) &&
            (g = this.isTouchDevice() ? 'always' : 'hover'),
          A || (A = 'h2, h3, h4, h5, h6'),
          0 === (i = t(A)).length)
        )
          return this
